...
namespace FamilyParameterEditor
{
    public class FamilyParamEditorForm : System.Windows.Forms.Form
    {
        ...
        public static System.Drawing.Point Position(string x, string y)
        {
            ...
            {
                if (
                    (num >= allScreens[i].Bounds.Left)
                    & (num < allScreens[i].Bounds.Right - 20)
                    & (num2 >= allScreens[i].Bounds.Top)
                    & (num2 < allScreens[i].Bounds.Bottom - 20)
                )
                {
                    flag = true;
                    break;
        ...
        private void BtnSelect_Click(object sender, EventArgs e)
        {
            ...
            if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                List<string> listFamilysFile = Directory
                    .GetFiles(
                ...
                foreach (string FamilysFile in listFamilysFile)
                {
                    ...
                    SetParameters(
                        familyDoc,
                        listExistSharedParamInFamilys,
                        listExistSharedParamTypeInFamilys
                    );
                    num++;
                    lb_Status.Text = string.Format(
                        "Обработано {0} семейств. Всего {1}\n" + "Текущий файл:{2}",
                        num,
                        listFamilysFile.Count,
                        Path.GetFileName(FamilysFile)
                    );
                }
                ...
                for (int j = 0; j < listExistSharedParamInFamilys.Count; j++)
                {
                    ...
                    var allowParamFromSPF =
                        from v in AllSharedParametrs
        ...
        private void CreateCustomComboBoxDataSouce(int row, List<string> data, string Name)
        {
            DataGridViewComboBoxCell dataGridViewComboBoxCell =
                dgv1[1, row] as DataGridViewComboBoxCell;
        ...
        private void SetParameters(
            Document FamilyDoc,
            List<string> OldParametersNames,
            List<ParameterType> OldParameters
        )
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnOk.Font = new System.Drawing.Font(
            ...
            this.dgv1.ColumnHeadersHeightSizeMode = System
                .Windows
                .Forms
                .DataGridViewColumnHeadersHeightSizeMode
                .AutoSize;
            this.dgv1.Columns.AddRange(
            ...
            this.dgv1.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(
                this.dgv1_CellContentClick
            );
            this.dgv1.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(
                this.dgv1_CellDoubleClick
            );
            //
            // TypeBlackWall
            //
            this.TypeBlackWall.AutoSizeMode = System
                .Windows
                .Forms
            ...
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(
                this.DeleteSharedParameterFrm_FormClosing
            );
